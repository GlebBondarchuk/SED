...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <br>
        <a class="btn btn-primary btn-lg" href="${applicationPath}/content/${departmentInfo.content.id}">Call to Action!</a>
    </div>
    <!-- /.col-md-4 -->
</div>
<!-- /.row -->
...
<div class="row">
    <div class="col-md-4">
        ...
        <a class="btn btn-default" href="${applicationPath}/content/${educational.content.id}">More Info</a>
    </div>
    <!-- /.col-md-4 -->
    <div class="col-md-4">
        <h2><spring:message code="label.nav.scientific"/></h2>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Saepe rem nisi accusamus error velit animi non ipsa placeat. Recusandae, suscipit, soluta quibusdam accusamus a veniam quaerat eveniet eligendi dolor consectetur.</p>
        <a class="btn btn-default" href="${applicationPath}/content/${scientific.content.id}">More Info</a>
    </div>
    <!-- /.col-md-4 -->
    <div class="col-md-4">
        <h2><spring:message code="label.nav.conferences"/></h2>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Saepe rem nisi accusamus error velit animi non ipsa placeat. Recusandae, suscipit, soluta quibusdam accusamus a veniam quaerat eveniet eligendi dolor consectetur.</p>
        <a class="btn btn-default" href="${applicationPath}/content/${conference.content.id}">More Info</a>
    </div>
    <!-- /.col-md-4 -->
</div>
<!-- /.row -->
